...
#             box_to_dictionary = doc.to_dict()
#             box = box_to_dictionary["Box"]
...
#             box_to_dictionary = doc.to_dict()
#             box = box_to_dictionary["Box"]
#             st.write(box_to_dictionary)
#             st.write(box)
            
#             # Extract key and value
#             studentid = list(box.keys())[0]
#             st.write(studentid)
#             doc_id = next(iter(box))  # or list(data.keys())[0]
#             doc_refs = box[doc_id]    # list of DocumentReference(s)

#             # Optional: unpack the list if you only need the first reference
#             doc_ref = doc_refs[0]
...
#             studentid = db.collection("Student").document()
#             doc = studentid.get()
